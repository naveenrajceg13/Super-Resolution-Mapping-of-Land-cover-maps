...
spsam1=spsam;
imwrite(spsam,strcat(filename,'-spsam.jpg'),'jpeg');
u=1;
v=1;
...
for i=1:m2
    for j=1:n2
      ...
      h(i,j)=temp1;
       ...
       onecount=(onecount*100)/(mapsize*mapsize);
       ...
       uposition=1;
       vposition=1;
         if(onecount<b(bindex))
            for it=onecount:b(bindex)
                position=randi([1,9]);
                     if(position<=3)
                         uposition=1;
                         vposition=position;
                 ...
                 if(xmatrix(uposition,vposition)==1)
                     it=it-1;
                     continue;
                 end
                 xmatrix(uposition,vposition)=1;
            end
         end
         if(onecount>b(bindex))
             for it=b(bindex):onecount
                position=rand([1,9]);
                     if(position<=3)
                         uposition=1;
                         vposition=position;
